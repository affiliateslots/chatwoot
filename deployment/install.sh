...
c=n d=n h=n i=n I=n l=n r=n s=n u=n w=n v=n BRANCH=deployment SERVICE=web
...
function upgrade() {
  ...
  # Pull the latest version of the deployment branch
...
function cwctl_upgrade_check() {
    ...
    local remote_version_url="https://raw.githubusercontent.com/chatwoot/chatwoot/deployment/VERSION_CWCTL"
